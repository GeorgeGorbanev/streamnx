...
func TestCallback_ConvertAlbumYoutubeToApple(t *testing.T) {
	tests := []struct {
		...
		{
			name:  "when youtube autogenerated album link given and apple album found",
			input: "cnval/yt/OLAK5uy_n4xauusTJSj6Mtt4cIuq4KZziSfjABYWU/ap",
			expectedMessages: []*telegram.Message{
				{
					To:   user,
					Text: "https://music.apple.com/us/album/space-oddity-2019-mix/1486212582",
				},
			},
			fixturesMap: fixture.FixturesMap{
				YoutubeAlbums: map[string][]byte{
					"OLAK5uy_n4xauusTJSj6Mtt4cIuq4KZziSfjABYWU": fixture.Read("youtube/get_album_david_bowie_space_oddity.json"),
				},
				YoutubePlaylistItems: map[string][]byte{
					"OLAK5uy_n4xauusTJSj6Mtt4cIuq4KZziSfjABYWU": fixture.Read("youtube/get_playlist_items_david_bowie_space_oddity.json"),
				},
				AppleSearchAlbums: map[string][]byte{
					"David Bowie Space Oddity": fixture.Read("apple/search_album_david_bowie_space_oddity.json"),
				},
			},
		},
		{
